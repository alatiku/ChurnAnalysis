...
# Churn Analysis on IBM Telco Customer Data
...
```{r tenure_dist, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r contract, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r payment, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r avg_contract, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
telco_cleaned %>%
    group_by(Contract) %>%
...
```{r avg_payment, message=FALSE, warning=FALSE, fig.height=8, fig.width=12}
telco_cleaned %>%
